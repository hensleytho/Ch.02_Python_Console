'''
Sign your name:__Tommy Hensley__

1.) How do you enter a single line comment in a program? Give an example.
use a hashtag #it will not affect the code
...
'''
x,y = 4,5 # do not need parenthesis
a = 3*(x + y) # need a multiplication sign behind the 3
a
'''
...
x,y,z =(3,4,5)
ave = x+y+z/3
print(ave) # needed the print in front of ave
'''
